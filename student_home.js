    ...
    function populateProfile(student) {
        ...
        if (statusIndicator) {
            if (student.status === 'Active') {
                statusIndicator.className = 'inline-block h-2.5 w-2.5 rounded-full bg-green-500';
            } else {
                statusIndicator.className = 'inline-block h-2.5 w-2.5 rounded-full bg-red-500';
            }
        }
